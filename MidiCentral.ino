...
static inline void loopEncoder() {
...
static inline void loopUpdateBpm() {
...
static inline void loopMidiForwarding() {
  if (midiA.read()) {
...
void setup() {
  ...
  // attach interrupts
  attachInterrupt(digitalPinToInterrupt(PIN_BTN_START), interruptStartButton, FALLING);
